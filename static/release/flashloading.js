...
(function(){
    ...
    document.write('<embed height="{{fheight}}" pluginspage="http://www.adobe.com/go/getflashplayer" {% if fwidth <=1000 %}src="http://p2.wan.sogoucdn.com/cdn/flash/2014/07/31/20140731100706_47.swf"{%else%}src="http://p7.wan.sogoucdn.com/cdn/flash/2014/05/13/20140513183020_816.swf"{%endif%} type="application/x-shockwave-flash" width="{{fwidth}}" wmode="opaque" quality="high" allowscriptaccess="always" id="Flash_Target" flashvars="flashurl='+ encodeURIComponent('{{flashUrl}}') +'&loadfunc='+ ffuncname +'" >');
